...
% +--------------------------------------------------------------------+
  ...
  %MODEL DRIVEN DEVELOPMENT FOR MEDICAL DEVICES IN AADL/BLESS AND SPARK ADA: PCA PUMP PROTOTYPE
  %\large MODEL DRIVEN DEVELOPMENT AND VERIFICATION IN AADL/BLESS AND SPARK ADA FOR MEDICAL DEVICES\\
  %\large MODEL DRIVEN DEVELOPMENT AND VERIFICATION FOR MEDICAL DEVICES IN AADL/BLESS AND SPARK ADA IN EXAMPLE OF PCA PUMP\\
  %\large MODEL DRIVEN DEVELOPMENT AND VERIFICATION IN AADL/BLESS AND SPARK ADA FOR A MEDICAL DEVICE: PCA INFUSION PUMP\\
  %\large MODEL DRIVEN DEVELOPMENT AND VERIFICATION IN AADL/BLESS AND SPARK ADA\\
  %\large MODEL DRIVEN DEVELOPMENT AND VERIFICATION IN AADL/BLESS AND SPARK ADA FOR A PCA PUMP\\
  %\large A MODEL-DRIVEN DEVELOPMENT AND VERIFICATION OF MEDICAL DEVICES\\
  \large A MODEL-DRIVEN DEVELOPMENT AND VERIFICATION APPROACH FOR MEDICAL DEVICES\\
  %\large MODEL-DRIVEN DEVELOPMENT AND VERIFICATION OF MEDICAL DEVICES USING AADL AND SPARK ADA\\
