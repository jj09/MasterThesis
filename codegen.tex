...
[remove this?] There is another proposition: map threads to subprograms (table \ref{table:threads2subprograms}) in case of single threaded programs. 
BOTH TABLES ARE INCOMPLETE!

\begin{table}[!ht]
	\caption{AADL package to SPARK Ada package mapping.}
