...
There is no equivalent construct for AADL property set in SPARK Ada. In this thesis only properties of type \lstinline{constant aadlinteger} are considered. There are issues with using non-constant in SPARK Ada (e.g. in type definition).
  	...
  	\begin{tabular}{ | p{3in} | p{3in} |}
		...
		\begin{lstlisting}
			...
			is
				...
				Some_Property2 : constant := 27;
				Some_Property3 : constant := Some_Property1;
			end Some_Properties;
		\end{lstlisting} 		
