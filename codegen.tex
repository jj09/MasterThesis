...
\singlespacing
\begin{lstlisting}[language=ada, frame=single, gobble=0, caption={Two way port communication translated to SPARK Ada}]
	with Base_Types;
	with Pkg2TwoWay;
	--# inherit Base_Types,
	--#         Pkg2TwoWay;
...
\singlespacing
\begin{lstlisting}[language=aadl, frame=single, gobble=0, caption={AADL model of port communication between systems}]
	package Panel
	public
	with Base_Types;
...
\singlespacing
\begin{lstlisting}[language=ada, frame=single, gobble=0, caption={Port communication translated to SPARK Ada}]
	with Pump;
	with Base_Types;
	--# inherit Pump,
	--#         Base_Types;
...
\end{lstlisting} 
\label{listing:port_communication_spark}
\doublespacing
