...
\usepackage{epigraph}       % Added by Jakub Jedryszek to support quotation
\usepackage{etoolbox}       % Added by Jakub Jedryszek to support quotation
\usepackage[strict]{changepage} % Added by Jakub Jedryszek for dedication page
\usepackage{caption} \captionsetup{labelfont=bf} % Added by Jakub Jedryszek to fix table captions
...
\appendix
%\lstset{numbers=left}
\input{appendix-terms.tex}
\input{appendix-pca_ravenscar.tex}
\input{appendix-pca_ravenscar-pogs.tex}
\input{appendix-aadl-rate_controller.tex}
\input{appendix-aadl.tex}
\input{appendix-pca_generated.tex}
\input{appendix-aunit.tex}
